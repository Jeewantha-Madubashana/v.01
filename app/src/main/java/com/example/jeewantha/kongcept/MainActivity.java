        ...
        try {
            ...
            if(obj.optString("status").equals("true")){
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    modelRecycler.setImgURL(dataobj.getString("emp_photo"));
                    modelRecycler.setName(dataobj.getString("emp_name"));
                    modelRecycler.setEmail(dataobj.getString("emp_email"));
                    modelRecycler.setBranchName(dataobj.getString("branch_name"));
                    modelRecycler.setBankName(dataobj.getString("bank_name"));
